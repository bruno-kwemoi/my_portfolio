  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      ...
      className='w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card'>
        ...
        py-5 px-12 mn-h-[280px] flex justify-evenly
...
const About = () => {
  return (
    ...
    My stack primarily revolves around web development.
    I'm comfortable with front-end technologies like HTML, CSS, and JavaScript. 
